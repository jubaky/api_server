...
class JenkinsService(
    ...
    suspend fun createCredentials(username: String, password: String, key: String, description: String, scope: String = "GLOBAL") {
        jenkinsRepository.createCredentials(username, password, key, description, scope)
    }
